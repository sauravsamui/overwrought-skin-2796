...
export default function Middle() {
    ...
    return (
        ...
        <p style={{fontWeight:"bold", fontSize:"30px", marginBottom:"6%", color:"rgb(19, 59, 103)"}}>Current Openings</p>
        <div className={style.currentLocation} style={{textAlign:"left"}}>
            ...
            <div {...getCollapseProps()}>
                <div className="content">
                    <div style={{width:"85%", marginLeft:"5%", fontSize:"smaller"}}>
                    ...
                    <h4 style={{fontWeight:"90px",margin:"2%"}} className={style.jobH4}>Android</h4>
                ...
                <h4 style={{fontWeight:"90px",margin:"2%"}}>iOS</h4>
                ...
                <h4 style={{fontWeight:"90px",margin:"2%"}}>Full Stack, Backend &amp; Infrastructure</h4>
