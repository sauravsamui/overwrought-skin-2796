      ...
      <div className={style.currentLocation} style={{textAlign:"left"}}>
        ...
        <div {...getCollapseProps()}>
          <div className="content">
            <div>
            <a style={{width:"85%", marginLeft:"5%", fontSize:"smaller", color:"orange"}} href="/jobs/business_analyst/">Business Analyst</a>
                <p style={{width:"85%", marginLeft:"5%", fontSize:"smaller"}}>We are looking for a graduating senior interested in data analytics to join our team as a Business Analyst in the spring.
